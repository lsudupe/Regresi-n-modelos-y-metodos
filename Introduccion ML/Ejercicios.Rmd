...
LoadLibraries <- function() {
  myLibraries <- c("faraway", "ggplot2", "dplyr")
...
ggplot(data = data) +
  geom_point(aes(verbal, gamble, colour = sex)) +
  facet_grid(~sex)

g1 <- ggplot(teengamb, aes (x = income, y = gamble, color = sex)) + geom_point()+
  theme(legend.position = "top", legend.direction = "horizontal")
 
g2 <- ggplot(teengamb, aes (x = income, y = gamble)) + geom_point(size = 1) + 
  facet_grid( ~ sex)
